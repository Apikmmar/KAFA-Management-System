...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ...
            ['role_id' => '2', 'user_name' => 'farisya', 'user_ic' => '222222222222', 'email' => '2@gmail.com', 'password' => Hash::make('22222222'), 'user_gender' => 'Women', 'user_contact' => '0222222222', 'user_verification' => 'testing.pdf', 'created_at' => $now, 'updated_at' => $now],
